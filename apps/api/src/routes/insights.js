 ...
 */
insightsRouter.post("/predict-conflicts", zValidator("json", conflictPredictionSchema), async (c) => {
 ...
 */
insightsRouter.post("/reviewer-fatigue", zValidator("json", fatigueSchema), async (c) => {
    ...
    return c.json({
        ...
        session: mockSession,
        analysis,
        recommendation: analysis.suggestedAction === "take_break"
