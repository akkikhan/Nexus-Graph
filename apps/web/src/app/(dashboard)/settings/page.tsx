    ...
    return (
        <div className="p-8 max-w-4xl mx-auto">
                            ...
                            <div className="divide-y divide-zinc-800">
                                {section.settings.map((setting) => (
                                    ...
                                    >
                                        ...
                                        {setting.type === "toggle" && (
                                            <button
                                                className={`relative w-12 h-6 rounded-full transition-colors ${setting.value ? "bg-nexus-500" : "bg-zinc-700"
                                                    }`}
                                            >
                                                <div
                                                    className={`absolute top-1 w-4 h-4 rounded-full bg-white transition-transform ${setting.value ? "right-1" : "left-1"
                                                        }`}
                                                />
                                            </button>
                                        )}
                                ...
                                {section.links.map((link) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span
                                                className={`text-sm ${link.status === "connected"
                                                        ? "text-green-400"
            ...
            <motion.div
                ...
                className="mt-8 p-6 bg-red-950/20 border border-red-500/30 rounded-xl"
            >
